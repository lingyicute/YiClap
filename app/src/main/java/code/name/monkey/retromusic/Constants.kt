...
object Constants {
    const val GITHUB_PROJECT = "https://github.com/lingyicute/YiClap/tree/Dt-000"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/lyi_channel"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val FAQ_LINK = "https://github.com/lingyicute/YiClap/blob/Dt-000/README.md"
